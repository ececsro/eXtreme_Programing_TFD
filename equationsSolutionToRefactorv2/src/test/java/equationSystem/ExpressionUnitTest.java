...
public class ExpressionUnitTest {
	...
	public void Given7Terms_clon() {
		...
		assertThat((double) exprExpected.termList.get(0).getValue(), closeTo(intNegative,closeGap));
		assertThat(exprExpected.termList.get(0).getName(), is(nameX));
		assertThat((double) exprExpected.termList.get(1).getValue(), closeTo(decimalNegative,closeGap));
		assertThat(exprExpected.termList.get(1).getName(), is(nameX));
		assertThat((double) exprExpected.termList.get(2).getValue(), closeTo(intNegative,closeGap));
		assertThat(exprExpected.termList.get(2).getName(), is(nullValue()));
		assertThat((double) exprExpected.termList.get(3).getValue(), closeTo(decimalPositive,closeGap));
		assertThat(exprExpected.termList.get(3).getName(), is(nameX));
		assertThat((double) exprExpected.termList.get(4).getValue(), closeTo(decimalNegative,closeGap));
		assertThat(exprExpected.termList.get(4).getName(), is(nullValue()));
		assertThat((double) exprExpected.termList.get(5).getValue(), closeTo(decimalNegative,closeGap));
		assertThat(exprExpected.termList.get(5).getName(), is(nameY));
		assertThat((double) exprExpected.termList.get(6).getValue(), closeTo(intNegative,closeGap));
		assertThat(exprExpected.termList.get(6).getName(), is(nameY));
